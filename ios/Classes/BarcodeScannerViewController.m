...
- (void)viewDidLoad {
    ...
    if ([@"kalium" isEqualToString:self.theme]) {
        bar.titleTextAttributes
             = @{NSForegroundColorAttributeName : [UIColor colorWithRed:0.98 green:0.87 blue:0.07 alpha:1.0]};
        bar.barTintColor = [UIColor colorWithRed:0.13 green:0.13 blue:0.14 alpha:1.0];
        bar.tintColor = [UIColor colorWithRed:0.98 green:0.87 blue:0.07 alpha:1.0];
        bar.translucent = NO;
    }
